...
st.sidebar.markdown("""
    ...
    <div style='background-color:#F1F5F9; padding:15px; border-radius:10px; text-align:center; border: 1px solid #E2E8F0;'>
        <a href='https://blog.naver.com/biologue_' target='_blank' style='color:#1a7689; text-decoration:none; font-weight:800; font-size:1.1rem;'>😀 블로그 바로가기</a>
    </div>
""", unsafe_allow_html=True)
st.sidebar.markdown("""
    <br><br>
    <div style='background-color:#F1F5F9; padding:15px; border-radius:10px; text-align:center; border: 1px solid #E2E8F0;'>
        <a href='https://www.instagram.com/biologist_logue' target='_blank' style='color:#1a7689; text-decoration:none; font-weight:800; font-size:1.1rem;'>🌻인스타그램 바로가기</a>
    </div>
""", unsafe_allow_html=True)
st.sidebar.markdown("""
    <br><br>
